...
import com.musicstore.service.StoreReportStreams;
...
public class TestReports {
    ...
    @Test
    public void testStreamReports() throws CustomerExistsException, OrderAlreadyExistsException, ProductOOSException, ProductAlreadyExistsException {
        MusicStore musicStore = new MusicStore();
        ...
        //REPORTS
        StoreReportStreams storeReportStreams = new StoreReportStreams(musicStore);

        System.out.println("Number of clients: " + storeReportStreams.getNumberOfClients());
        System.out.println("Number of orders: " + storeReportStreams.getNumberOfOrders());
        System.out.println("Sum of all orders: $" + storeReportStreams.sumAllOrders());

        Set<Order> finishedOrders = storeReportStreams.finishedOrders();
        Set<Order> ordersSorted = storeReportStreams.getOrdersSortedByTotalPrice();
